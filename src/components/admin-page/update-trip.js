            ...
            <div className="container my-5">
                ...
                <Form style={{ width: "90%" }} className="m-auto my-4" onSubmit={(e) => HandleInput.mutate(e)}>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control type="text" className="bg-dark-subtle" id="title" name="title" onChange={handleOnChange} />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control type="text" className="bg-dark-subtle" name="accomodation" onChange={handleOnChange}  />
                    </Form.Group>

                    <Form.Group className="mb-3" >
                        <Form.Label className="fw-bold">Transportation</Form.Label>
                        <Form.Control type="text" className="bg-dark-subtle" name="transportation" onChange={handleOnChange} />
                    </Form.Group>

                    <Form.Group className="mb-3" >
                        <Form.Label className="fw-bold">Eat</Form.Label>
                        <Form.Control type="text" className="bg-dark-subtle" name="eat" onChange={handleOnChange}  />
                    </Form.Group>

                    <Form.Group className="mb-3" >
                        <Form.Label className="fw-bold">Duration</Form.Label>
                        <div className="d-flex" >
                            <Form.Control type="number" style={{ width: "20%" }} className="me-3 bg-dark-subtle" name="day" onChange={handleOnChange} />
                            <Form.Label className="fw-bold me-3">Day</Form.Label>

                            <Form.Control type="number" style={{ width: "20%" }} className="me-3 bg-dark-subtle" name="night" onChange={handleOnChange} />
                    ...
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control type="number" className="bg-dark-subtle" id="price" name="price" onChange={handleOnChange} />
                    </Form.Group>


                    <Form.Group className="mb-3" >
                        <Form.Label className="fw-bold">Quota</Form.Label>
                        <Form.Control type="number" className="bg-dark-subtle" name="quota" onChange={handleOnChange} />
                    </Form.Group>

                    <Form.Group className="mb-3" >
                        <Form.Label className="fw-bold">Description</Form.Label>
                        <Form.Control className="bg-dark-subtle" as="textarea" rows={3} style={{ resize: "unset" }} name="description" onChange={handleOnChange} />
                    </Form.Group>

                    <Form.Group className="mb-3 row" >
                        <Form.Label className="fw-bold">Image</Form.Label>
                        <Form.Control type="file" className="bg-dark-subtle" style={{ width: "25%" }} name="image" onChange={handleOnChange} />
